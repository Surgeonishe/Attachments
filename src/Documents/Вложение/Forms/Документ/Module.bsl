...
Процедура сформироватьHTML ()
	...
	п = Новый Структура ();
	п.Вставить ( "ИмяФайла", данные.Описание );
...
//	шаблон = РаботаСФайлами.ПолучитьШаблонHTML ( расширение );
//	Если ( шаблон = "" ) Тогда
//		HTMLСтрока = "";
//	Иначе
//		Если ( расширение = ".pdf" ) Тогда
//			с = СтрЗаменить ( шаблон, "#path#", полноеИмяФайла );
//		ИначеЕсли ( расширение = ".xml" ИЛИ расширение = ".txt" ) Тогда
//			текст = получитьТекстИзФайла ( полноеИмяФайла );
//			с = СтрЗаменить ( шаблон, "#text#", текст );
//		ИначеЕсли ( расширение = ".jpg" ИЛИ расширение  = "jpeg" ИЛИ расширение = ".gif" 
//					ИЛИ расширение = ".png" ИЛИ расширение = ".tif" ) Тогда
//			с = СтрЗаменить ( шаблон, "#path#", полноеИмяФайла );
//		КонецЕсли; 
//		с = СтрЗаменить ( с, "#width#", "" + Масштаб );
//		высота = Масштаб * 2.05;
//		с = СтрЗаменить ( с, "#height#", Формат ( высота, "ЧРД=." ) );
//		HTMLСтрока = с;
//	КонецЕсли; 
