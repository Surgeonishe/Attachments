...
Процедура заполнитьИндексыКартинок ()
	...
	Для Каждого строкаТЧ Из Объект.Файлы Цикл
		заполнитьИндексКартинки ( строкаТЧ );
	КонецЦикла;
			
КонецПроцедуры

&НаКлиенте
Процедура заполнитьИндексКартинки ( Данные )
	
	Если ( Данные = Неопределено ) Тогда
		Возврат;
	КонецЕсли; 
	Если ( Данные.ИмяФайла <> "" ) Тогда
		Данные.ИндексКартинки = РаботаСФайлами.ИндексПиктограммы ( Данные.ИмяФайла );
	КонецЕсли;
...
Процедура ФайлыПриАктивизацииСтроки(Элемент)
	...
	Если ( данные <> Неопределено ) Тогда
		сформироватьHTML ();
	КонецЕсли;
	заполнитьИндексКартинки ( данные )
